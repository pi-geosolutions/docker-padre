...
GeoNetwork.Lang.nl = {
    ...
    'wxs-extract-service-not-found': 'Error connecting to the service http://geonetwork-opensource.org/geonetwork-client. ${misc}.',
    'wxs-extract-layer-not-found': 'Layer ${layer} not found in WFS (http://geonetwork-opensource.org/geonetwork-client).',
    'GML2': 'GML 2',
    'GML3': 'GML 3',
    'CSV': 'Text CSV',
    ...
    'wxs-extract-service-not-found': 'Fout bij het verbinden met de service http://geonetwork-opensource.org/geonetwork-client. ${misc}.',
    'wxs-extract-layer-not-found': 'Kaartlaag ${layer} niet gevonden in WFS (http://geonetwork-opensource.org/geonetwork-client).',
    'GML2': 'GML 2',
    'GML3': 'GML 3',
    'CSV': 'Text CSV',
    'SHAPE-ZIP': 'ESRI Shapefile',
